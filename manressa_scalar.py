...
try:
    f = open("/Users/kimigrace/Desktop/CSE161/manresa_scalar_512.raw", "rb")   
except IOError:
...
# 	img = Image.frombytes('RGB', (512, 720), scalar_slice_img)
...
# print("Making Gif please wait ... \n ...")

# gif = []
# for image in img_array:
#     gif.append(image)

# gif[0].save('manressa_timestack_scalar.gif',
